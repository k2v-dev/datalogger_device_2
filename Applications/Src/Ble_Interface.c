...
#define DEVICE_NAME                     "Neck_Device2"                               /**< Name of device. Will be included in the advertising data. */
...
#define MAX_CONN_INTERVAL               MSEC_TO_UNITS(10, UNIT_1_25_MS)             /**< Maximum acceptable connection interval (10 ms), Connection interval uses 1.25 ms units. */
...
#define RATE				            APP_TIMER_TICKS(2.5)							/**<  Data rate or Interrupt rate @ Data is send over BLE */
